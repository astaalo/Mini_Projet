...
<head>
 <meta charset="utf-8">
 <link rel="StyleSheet" type="text/css" href="InterJoueurs.css"/>
 <title> Interface Joueurs </title>
     ...
     <body> 
        <div class="blog">  
            ...
            <div id="log">
                <div id="avatar">
                    <a href="#"><img src="img/img5.jpg" alt=""></a></div>
                    <a href="deconnexion.php"><button type="submit" name="deconnexion">Deconnexion</button></a>
                    <h5> BIENVENUE SUR LA PLATEFORME DE JEU DE QUIZZ<br>
                    JOUER ET TESTER VOTRE NIVEAU DE CULTURE GÉNÉRALE </h5>
            </div><br><br>
               <div id="blog1">
                   <!-- <div id="avatar">
